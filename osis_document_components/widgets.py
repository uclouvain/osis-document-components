...
class HiddenFileWidget(MultipleHiddenInput):
    template_name = 'osis_document_components/hidden_widget.html'
...
class FileUploadWidget(SplitArrayWidget):
    template_name = 'osis_document_components/uploader_widget.html'

    class Media:
        css = {'all': ('osis_document_components/osis-document.css',)}
        js = ('osis_document_components/osis-document.umd.min.js',)
